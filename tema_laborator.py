...
def nume_count(dict_cnp):
    return Counter(dict_cnp.values())
...
def cautare_hash_table_pe_mod1000(hash_table_pe_mod1000, cnp_de_cautat):
    hash_value=[[0]*1000]
    hash_value = cnp_de_cautat % 1000
    for index,hash_value in hash_table_pe_mod1000.items():
        for 
